...
export const AvatarSection = () => {
  ...
  return (
    <div ref={ref} className="relative items-center">
      <Account open={open} setOpen={setOpen} data={account} />

      <div
        onClick={() => setIsShow(!isShow)}
        className="relative cursor-pointer h-10 w-10 z-50 rounded-sm bg-cover transition-all hover:scale-105"
        style={{
          backgroundImage: `url(${account.avatar || "/images/avatar.jpg"})`,
        }}
      >
        <span className="absolute top-0 left-0 w-full h-full bg-primary/20 hover:bg-primary/30 transition-all"></span>
      </div>
      <div
          ...
          <div className="flex h-24 items-center">
            <div className="w-5/12 items-center flex justify-center">
              <div
                ...
                style={{
                  backgroundImage: `url(${
                    account.avatar || "/images/avatar.jpg"
                  })`,
                }}
              ></div>
            </div>
